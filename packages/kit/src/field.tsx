...
interface FieldProps {
  ...
  hint?: string;
  /**
   * Validation error message, already resolved. Rendered under the hint.
   *
   * LIFT NOTE — upstream this was an i18n KEY and the component called `t()` on
   * it. The kit carries no i18n runtime, so the caller resolves it. Callers that
   * already hold a resolved string are unaffected; callers that held a key must
 ...
 * `error` is a resolved message (see the prop doc).
 *
